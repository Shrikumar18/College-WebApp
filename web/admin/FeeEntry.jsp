...
<html lang="en-US">
 ...
 <body class="home page page-id-115 page-template-default has-toolbar">
      ...
      <section class="section-content section-bg" style="background-color:#f5f5f5;"><div class="container clearfix"><div class="entry-content">
                        ...
                        <div id ="manual"><form method="post" action="ChallanEntry.jsp" >
                                <center> <label>Mup No  :  </label><input type="text" style="background: white" id="mup" name="mup"><br><br>
                                    <label>Date  :  </label><input type="date" id="datepicker" style="background: white" class="date" name="date" /></center>
                                <div align="center">
                                    <br><br>
